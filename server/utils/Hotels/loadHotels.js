...
const storeDestIdOfLargestCity = async (cityName) => {
  const cities =  await axios.get(`https://apidojo-booking-v1.p.rapidapi.com/locations/auto-complete?languagecode=en-us&text=${cityName}`, {
	  "headers": {
